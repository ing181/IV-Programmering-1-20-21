...
FÖR ATT SKAPA ETT STATISKT PROGRAM
Ett statiskt program plockar in de biblioteksfiler som behövs in i exe-filen. Jämför storleken 
på exe-filen i syskonmappen "dynamic"

"C:\Program Files\CodeBlocks\MinGW\bin\g++" main.cpp -o mittprogram.exe -static-libgcc -static-libstdc++ -static -lpthread (Glöm inte "") 
